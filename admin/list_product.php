                                    ...
                                    <?php
                                      ...
                                      if($result && mysqli_num_rows($result) > 0){
                                        ...
                                        do {
                                          ...
                                          echo '<td class="text-center"><img src="./uploads/product/'.$row['img_name'].'" alt="'.$row['title'].'" height="70px"></td>';
                                          $status_checked = '';
                                          if($row['status'] == 0) {
                                            $status_checked = '';
                                          ...
                                          echo '<td class="text-center"><a href="./list_product_variant.php?id='.$row['id'].'" class="btn btn-secondary">Add Variant</a></td>';
                                          echo '<td class="text-center"><a href="product_edit.php?id='.$row['id'].'" class="btn btn-primary">Edit</a></td>';
                                          echo '<td class="text-center"><a id="delete-'.$row['id'].'" href-url="delete_product.php" href="javascript:void(0);" onclick="confirmation('.$row['id'].');" class="btn btn-danger">Delete</a></td>';
                                          echo '</tr>';
                                          $i++;
                                        } while($row = mysqli_fetch_assoc($result));
                                      } else {
                                        ?>
                                        <tr><td colspan="10" class="text-center">No Product Found</td></tr>
                                        <?php
                                      }
                                    ?>
                                </tbody>
