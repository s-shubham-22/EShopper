...
<body id="page-top">
                                    ...
                                    <?php
                                      ...
                                      if($result && mysqli_num_rows($result) > 0){
                                        ...
                                        do {
                                          ...
                                          echo '<td class="text-center"><img src="./uploads/sliders/'.$row['img_name'].'" alt="'.$row['title'].'" height="150px" max-width="150px"></td>';
                                          $status_checked = '';
                                          if($row['status'] == 0) {
                                            $status_checked = '';
                                          ...
                                          echo '<td class="text-center"><a href="home_slider_edit.php?id='.$row['id'].'" class="btn btn-primary">Edit</a></td>';
                                          echo '<td class="text-center"><a id="delete-'.$row['id'].'" href-url="delete_slider.php" href="javascript:void(0);" onclick="confirmation('.$row['id'].');" class="btn btn-danger">Delete</a></td>';
                                          echo '</tr>';
                                          $i++;
    ...
    <script>
        ...
        function confirmation(id){
            var answer = confirm("Are you sure you want to delete this slider?");
            if(answer){
                $.ajax({
