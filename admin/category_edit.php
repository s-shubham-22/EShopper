                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        if($result && mysqli_num_rows($result) > 0){
                            ...
                            $_SESSION['err'] = 1;
                            $_SESSION['errmsg'] = "No category found! But you can create a New Category Here!";
                            exit;
                        }
                    ?>
                    ...
                    <div class="card-body">
                        <form action="edit_category.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="title">Category Title <strong class=text-danger>*</strong></label>
                            ...
                            <div class="form-group">
                                <label for="img_name">Category Image <strong class=text-danger>*</strong></label>
                                <input type="file" class="form-control-file" id="img_name" name="img_name">
                                <br><img id="preview_img" src="./uploads/category/<?php echo $img_name; ?>" alt="your image" width="150px" /><br>
                            </div>
