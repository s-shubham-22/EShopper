...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between">
                      <h1 class="h3 mb-0 text-gray-800">Variant (<?php 
                        $pid = $_GET['id'];
                  ...
                  <div class="d-flex justify-content-end">
                    <a href="./product_variant.php?id=<?php echo $pid; ?>">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                      $sql = "SELECT * FROM product_variant WHERE pid = '$pid'";
                                      $result = mysqli_query($conn, $sql);
                                      if($result && mysqli_num_rows($result) > 0){
                                        ...
                                        do {
                                          ...
                                          echo '<td class="text-center"><img src="./uploads/product_variant/'.$row['img_name'].'" alt="No Image" height="70px"></td>';
                                          $status_checked = '';
                                          if($row['status'] == 0) {
                                            $status_checked = '';
                                          ...
                                          echo '<td class="text-center"><a href="product_variant_edit.php?id='.$row['id'].'&pid='.$pid.'" class="btn btn-primary">Edit</a></td>';
                                          echo '<td class="text-center"><a id="delete-'.$row['id'].'" href-url="delete_product_variant.php" href="javascript:void(0);" onclick="confirmation('.$row['id'].');" class="btn btn-danger">Delete</a></td>';
                                          echo '</tr>';
                                          $i++;
                                        } while($row = mysqli_fetch_assoc($result));
                                      } else {
                                        ?>
                                        <tr><td colspan="7" class="text-center">No Product Variant Found</td></tr>
                                        <?php
                                      }
                                    ?>
                                </tbody>
    ...
    <script>
        ...
        function confirmation(id){
            var answer = confirm("Are you sure you want to delete this Product Variant?");
            if(answer){
                $.ajax({
