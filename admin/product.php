                    ...
                    <div class="card-body">
                        <form action="add_product.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sale_price" name="sale_price" aria-describedby="emailHelp" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <br><img id="preview_img" src="" alt="your image" width="150px" />
                            </div>
                            <div class="form-group">
                                <label for="description">Description <strong class=text-danger>*</strong></label>
                                <textarea class="form-control" id="description" name="description" rows="4" cols="100" required></textarea>
                            </div>
