...
<body id="page-top">
                                    ...
                                    <?php
                                      ...
                                      if($result && mysqli_num_rows($result) > 0){
                                        ...
                                        do {
                                          ...
                                          echo '<td class="text-center"><a href="variant_edit.php?id='.$row['id'].'" class="btn btn-primary">Edit</a></td>';
                                          echo '<td class="text-center"><a id="delete-'.$row['id'].'" href-url="delete_variant.php" href="javascript:void(0);" onclick="confirmation('.$row['id'].');" class="btn btn-danger">Delete</a></td>';
                                          echo '</tr>';
                                          $i++;
                                        } while($row = mysqli_fetch_assoc($result));
                                      } else {
                                        ?>
                                        <tr><td colspan="6" class="text-center">No Variant Found</td></tr>
                                        <?php
                                      }
                                    ?>
                                </tbody>
    ...
    <script>
        ...
        function confirmation(id){
            var answer = confirm("Are you sure you want to delete this Variant?");
            if(answer){
                $.ajax({
