                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        if($result && mysqli_num_rows($result) > 0){
                            ...
                            $_SESSION['err'] = 1;
                            $_SESSION['errmsg'] = "No brand found! But you can create a New Brand Here!";
                            exit;
                        }
                    ?>
                    ...
                    <div class="card-body">
                        <form action="edit_brand.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <br><img id="preview_img" src="./uploads/brand/<?php echo $img_name; ?>" alt="your image" width="150px" /><br>
                            </div>
