            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Product Variant (<?php 
                          $pid = $_GET['id'];
                    ...
                    <div class="card-body">
                        <form action="add_product_variant.php" method="post" enctype="multipart/form-data">
                                  ...
                                  <?php
                                    ...
                                    if ($result && mysqli_num_rows($result) > 0) {
                                        while($row = mysqli_fetch_assoc($result)) {
                                            echo '<option value="'.$row['id'].'">'.$row['v_value'].'</option>';
                                        }
                                    }
                                  ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                  ...
                                  if ($result && mysqli_num_rows($result) > 0) {
                                      ...
                                      while($row = mysqli_fetch_assoc($result)) {
                                          echo '<div id="'.$row['id'].'">
                                          <input type="radio" name="color" value="'.$row['id'].'" '.$checked.'>
                                            <span style="background-color:'.$row['v_value'].'; width:50px; height:30px; display:inline-block; border: 1px solid grey; border-radius: 3px;"></span></div>';
                                            $checked = '';
                                      }
                                  }
                                ?>
